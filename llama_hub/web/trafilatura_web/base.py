...
class TrafilaturaWebReader(BaseReader):
    ...
    def load_data(self, urls: List[str], include_comments=True, output_format='txt', include_tables=True, include_images=False, include_formatting=False, include_links=False) -> List[Document]:
        ...
        for url in urls:
            ...
            response = trafilatura.extract(downloaded, include_comments=include_comments, output_format=output_format, include_tables=include_tables, include_images=include_images, include_formatting=include_formatting, include_links=include_links)

...
class StreamlitChatPack(BaseLlamaPack):
    ...
    def run(self, *args: Any, **kwargs: Any) -> Any:
        ...
        st.set_page_config(page_title=f"Chat with {self.wikipedia_page}'s Wikipedia page, powered by LlamaIndex", page_icon="🦙", layout="centered", initial_sidebar_state="auto", menu_items=None)
        ...
        st.title(f"Chat with {self.wikipedia_page}'s Wikipedia page, powered by LlamaIndex 💬🦙")

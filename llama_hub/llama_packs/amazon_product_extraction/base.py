...
async def _screenshot_page(url: str, out_path: str, width: int = 1200, height: int = 800) -> None:
...
url = "https://www.amazon.com/Logitech-Calling-Noise-Canceling-Correction-Microsoft/dp/B09NBWWP79/ref=pd_ci_mcx_mh_mcx_views_0?pd_rd_w=VnCfb&content-id=amzn1.sym.225b4624-972d-4629-9040-f1bf9923dd95%3Aamzn1.symc.40e6a10e-cbc4-4fa5-81e3-4435ff64d03b&pf_rd_p=225b4624-972d-4629-9040-f1bf9923dd95&pf_rd_r=ZPZ774JDJQDY43PATM6M&pd_rd_wg=nuNjh&pd_rd_r=93bf57c8-61a5-4664-845a-52b8a484259e&pd_rd_i=B09NBWWP79"
...
class AmazonProductExtractionPack(BaseLlamaPack):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        asyncio.get_event_loop().run_until_complete(_screenshot_page(
            website_url, tmp_file_path, width=screenshot_width, height=screenshot_height
        ))

        # put your local directory here
        self.image_documents = SimpleDirectoryReader(input_files=[tmp_file_path]).load_data()
